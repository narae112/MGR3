...
import com.MGR.config.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/private/**").authenticated() //private 로 시작하는 uri 는 로그인 필수
                ...
                .formLogin((login) -> login // form login 관련 설정
                        .loginPage("/loginForm")
                        .usernameParameter("name") // Member 가 username 이라는 파라미터 갖고 있으면 안 적어도 됨.
